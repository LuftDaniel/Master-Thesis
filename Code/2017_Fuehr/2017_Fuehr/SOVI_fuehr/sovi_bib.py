...
def solve_adjoint(meshData, y, z, lmbda_c_root, c):
    """
    Loest Adjungierte Gleichung
    """
...
def solve_linelas(meshData, p, y, lmbda_c, z, fValues, mu_elas, nu):
    """
    Loest lineare Elastizitaetsgleichung
    """
    ...
    # Norm der assemblierten rechten Seite wegen Abbruchbedinung
    ...
    # Rueckgabe des Deformationsvektorfeldes U und der Abbruchbedinung
    return U, nrm_f_elas
