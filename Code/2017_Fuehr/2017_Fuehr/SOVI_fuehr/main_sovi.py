...
while nrm_f_elas > tol_shopt:
    ...
    p = sovi.solve_adjoint(MeshData, y, z, lmbda_c, c)

    # ----------------------- #
    #     LIN. ELAS. PDE      #
    # ----------------------- #

    U, nrm_f_elas = sovi.solve_linelas(MeshData, p, y, lmbda_c_squared, z,
...
print("\n\n-------------------Fertig------------------------\n")
print("Iterationen:            {0:d}".format(counter))
print("Dauer der Berechnungen: {0:d} min".format(int(elapsed_time)/60))
