...
\begin{align*}
	...
	\end{matrix}\right),
\end{align*}
\textit{verallgemeinerte Spurabbildung}, wobei $\partial_n U_{\vert\partial\Omega_2}$ die Ableitung von $U$ auf der Form $\partial \Omega_2$ in Richtung des äußeren Normalenvektorfeldes $n$ ist.
\end{defi}
