...
\colorbox{red}{AMIJO? ist die Initialisierung wirklich interessant? Name counterer?}
\begin{lstlisting}
if(Linesearch):
...
Es ist außerdem möglich, statt der einfachen Backtracking Bedingung, die sogenannte \textit{Amijo-Bedingung} mit Hilfe eines Backtracking-Verfahrens zu implementieren.
...
Wir kommen im Kapitel zur Implementierung abschließend zum Output des Programs.
...
Diese Datei lässt sich im Rahmen des Postprocessings bequem mit Programmen wie \textit{Excel} oder \textit{RStudio} bearbeiten. Im nun folgenden und letzten Kapitel werden wir solche Analysen für einige von uns ausgewählte Routinen vorstellen.
