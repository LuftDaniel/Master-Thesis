...
\item[ii)] $\Omega$ ist zusammenhängend, beschränkt und besitzt einen Lipschitz-Rand.
\end{itemize}
...
Wir kommen nun zu einer, zwar immer noch abstrakt gehaltenen, jedoch konkreter anwendungsbezogenen Formulierung von Formoptimierungsproblemen, vgl. \cite{LagrangeNewton}, Abschnitt 2.
